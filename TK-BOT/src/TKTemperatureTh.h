...
#ifndef TKTemperatureTh_H
#define TKTemperatureTh_H
...
/**
 * Class: TKTemperatureTh
 * \par Description
 * Declaration of Class TKTemperatureTh.
 */
#ifndef TK_PORT_DEFINED
class TKTemperatureTh
#else // !TK_PORT_DEFINED
class TKTemperatureTh : public TKPort
#endif // !TK_PORT_DEFINED
{
public:
#ifdef TK_PORT_DEFINED
 ...
 *   slot - SLOT1 or SLOT2
 */
  TKTemperatureTh(uint8_t port, uint8_t slot);
#else // TK_PORT_DEFINED
/**
 * Alternate Constructor which can call your own function to map the temperature sensor to arduino port.
 * \param[in]
